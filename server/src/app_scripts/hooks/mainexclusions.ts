...
import MainExclusions from '../tables/types/MainExclusionsType';

export default class mainexclusions extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: MainExclusions = <MainExclusions>_row;
    // Write your code below
