...
import MainInclusions from '../tables/types/MainInclusionsType';

export default class maininclusions extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: MainInclusions = <MainInclusions>_row;
    // Write your code below
