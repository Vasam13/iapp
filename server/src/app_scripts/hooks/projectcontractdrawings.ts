...
import ProjectContractDrawings from '../tables/types/ProjectContractDrawingsType';

export default class projectcontractdrawings extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: ProjectContractDrawings = <ProjectContractDrawings>_row;
    // Write your code below
