...
import GlobalTemplates from '../tables/types/GlobalTemplatesType';

export default class globaltemplates extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: GlobalTemplates = <GlobalTemplates>_row;
    // Write your code below
