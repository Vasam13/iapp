...
import MiscInclusions from '../tables/types/MiscInclusionsType';

export default class miscinclusions extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: MiscInclusions = <MiscInclusions>_row;
    // Write your code below
