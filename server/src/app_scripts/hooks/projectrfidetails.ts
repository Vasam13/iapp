...
import ProjectRfiDetails from '../tables/types/ProjectRfiDetailsType';

export default class projectrfidetails extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: ProjectRfiDetails = <ProjectRfiDetails>_row;
    // Write your code below
