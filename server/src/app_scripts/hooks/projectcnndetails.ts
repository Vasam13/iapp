...
import ProjectCnnDetails from '../tables/types/ProjectCnnDetailsType';

export default class projectcnndetails extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: ProjectCnnDetails = <ProjectCnnDetails>_row;
    // Write your code below
