...
import MiscExclusions from '../tables/types/MiscExclusionsType';

export default class miscexclusions extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: MiscExclusions = <MiscExclusions>_row;
    // Write your code below
