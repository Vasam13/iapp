...
import ProjectTaskDetails from '../tables/types/ProjectTaskDetailsType';

export default class projecttaskdetails extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: ProjectTaskDetails = <ProjectTaskDetails>_row;
    // Write your code below
