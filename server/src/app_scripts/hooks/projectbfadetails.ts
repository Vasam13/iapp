...
import ProjectBfaDetails from '../tables/types/ProjectBfaDetailsType';

export default class projectbfadetails extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: ProjectBfaDetails = <ProjectBfaDetails>_row;
    // Write your code below
