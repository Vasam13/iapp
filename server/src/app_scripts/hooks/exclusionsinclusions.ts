...
import ExclusionsInclusions from '../tables/types/ExclusionsInclusionsType';

export default class exclusionsinclusions extends Table {
  ...
  public async afterQuery(_row: Row) {
    const row: ExclusionsInclusions = <ExclusionsInclusions>_row;
    // Write your code below
